...
// rkyv 0.8 zero-copy archival. Like `FromBytes`/`Pod`, this is derived
// unconditionally: every i64 is a valid D64, so the auto-generated bytecheck is
// total and no invariant guard is needed (contrast `D96`, which adds a `Verify`).
#[cfg_attr(
    feature = "rkyv",
...
impl D64 {
    ...
    pub const fn as_integer_ratio(self) -> (i64, u64) {
        ...
        let g = gcd_u128((self.value as i128).unsigned_abs(), denom);
        (self.value / g as i64, (denom / g) as u64)
    }
